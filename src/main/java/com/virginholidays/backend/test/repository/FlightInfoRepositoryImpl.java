...
public class FlightInfoRepositoryImpl implements FlightInfoRepository {
    ...
    @Override
    public CompletionStage<Optional<List<Flight>>> findFlightsByDate(LocalDate outboundDate) {

        LOGGER.info("Loading flight information for outbound date: {}", outboundDate);
